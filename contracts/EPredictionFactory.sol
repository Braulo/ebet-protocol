...
contract EPredictionFactory{
    ...
    function createPrediction(bool closedPrediction, string memory condition, address[] memory whitelist) public {
        EPrediction prediction = new EPrediction(closedPrediction, condition, msg.sender, whitelist);
